...
function initialize() {
    ...
    if (map_for_landing_page != null){
        initialize_map_for_landing_page();
    }
    var map_for_measurement  = document.getElementById("map_for_measurement");
    if (map_for_measurement != null){
        initialize_map_for_measurement();
    }
}

function initialize_map_for_landing_page() {
    ...
    map = new google.maps.Map(document.getElementById("map_for_landing_page"), myOptions);
...
function initialize_map_for_measurement() {
    var latlng = new google.maps.LatLng(37.75, 140.4666667);
    var myOptions = {
        zoom: 5,
        center: latlng,
